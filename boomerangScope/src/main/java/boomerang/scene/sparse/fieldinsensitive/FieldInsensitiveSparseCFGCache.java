...
public class FieldInsensitiveSparseCFGCache implements SparseCFGCache {
  List<SparseCFGQueryLog> logList = new ArrayList<>();

  Map<String, SparseAliasingCFG> cache;
  FieldInsensitiveSparseCFGBuilder sparseCFGBuilder;

  private static FieldInsensitiveSparseCFGCache INSTANCE;

  private FieldInsensitiveSparseCFGCache() {}

  public static FieldInsensitiveSparseCFGCache getInstance() {
    if (INSTANCE == null) {
      INSTANCE = new FieldInsensitiveSparseCFGCache(new FieldInsensitiveSparseCFGBuilder(true));
    }
    return INSTANCE;
  }

  private FieldInsensitiveSparseCFGCache(FieldInsensitiveSparseCFGBuilder sparseCFGBuilder) {
