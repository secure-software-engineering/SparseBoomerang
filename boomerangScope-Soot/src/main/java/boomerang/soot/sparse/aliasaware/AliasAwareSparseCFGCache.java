package boomerang.soot.sparse.aliasaware;

import boomerang.scene.Statement;
import boomerang.scene.Val;
import boomerang.soot.jimple.JimpleMethod;
import boomerang.soot.jimple.JimpleStatement;
...
public class AliasAwareSparseCFGCache implements SparseCFGCache<JimpleMethod, JimpleStatement> {
    ...
    // TODO: unify in super
    @Override
    public SparseAliasingCFG getSparseCFGForForwardPropagation(JimpleMethod m, JimpleStatement stmt, Val val) {
    ...
    public synchronized SparseAliasingCFG getSparseCFGForBackwardPropagation(
        ...
        queryLog.logStart();
        SparseAliasingCFG cfg =
                sparseCFGBuilder.buildSparseCFG(initialQueryVal, sootCurrentMethod, currentVal, sootCurrentStmt, queryLog);
        queryLog.logEnd();
        cache.put(key, cfg);
        logList.add(queryLog);
        return cfg;
    ...
    private static class ChainedCacheKeyImpl implements CacheKey {
        ...
        public boolean equals(Object obj) {
            ...
            return getSignature().equals(obj1.getSignature()) && getQueryStmt().equals( obj1.getQueryStmt() ) && getInitialQueryVal().equals( obj1.getInitialQueryVal() );
        }
    ...
    private static class CacheKeyImpl implements CacheKey {
        ...
        public CacheKeyImpl(JimpleMethod signature, Val initialQueryVal, Statement sootInitialQueryStmt) {
        ...
        public boolean equals(Object obj) {
            ...
            return getSignature().equals(other.getSignature()) && getQueryStmt().equals( other.getQueryStmt() ) && getInitialQueryVal().equals( other.getInitialQueryVal() );
        }
