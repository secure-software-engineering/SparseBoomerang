...
public class CustomFlowFunctionTest {
  ...
  //        Scene.v()
  //            .getMethod(
  //                "<boomerang.guided.targets.CustomFlowFunctionIntTarget: void
  ...
  //
  //    // For the query no allocation site is found, as between queryFor and the allocation site
  // there
  ...
  //        Scene.v()
  //            .getMethod(
  //                "<boomerang.guided.targets.CustomFlowFunctionTarget: void
  // main(java.lang.String[])>");
  //    BackwardQuery query = selectQueryForStatement(m);
  //
  //    SootCallGraph sootCallGraph = new SootCallGraph();
  ...
  //    method.getStatements().stream().filter(x -> x.containsInvokeExpr()).forEach(x ->
  // x.toString());
  ...
  //            .findFirst()
  //            .get();
  //    Val arg = new AllocVal(intAssignStmt.getLeftOp(), intAssignStmt,
  // intAssignStmt.getRightOp());
  //
  //    Statement succs =
